...
4. <span class="header_2" id="4">Definitions</span>
    ...
    4. **"Input"** means the data, information, prompts, or materials submitted by or on behalf of <span class="coverpage_link">Customer</span> or Users to the AI Services but excludes Feedback.
